    ...
    <body >
        ...
        <div class="container-fluid p-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h1>API REST | Caso de estudio | Taller Tecnico Hardware</h1>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="card ">
                                        ...
                                        <div class="card-footer"><code class="text-sm"><small> http://api.tecnicos.test/v1/insertClients</small></code></div>
                                    </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="card card-hin">
                                        ...
                                        <div class="card-footer"><code class="text-sm"><small> http://api.tecnicos.test/v1/showClients</small></code></div>
                                    </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="card ">
                                        ...
                                        <div class="card-footer"> <code class="text-sm"><small>http://api.tecnicos.test/v1/updateClients/{id}</small></code> </div>
                                    </div>
                                ...
                                <div class="col-lg-3 ">
                                    <div class="card ">
                                        ...
                                        <div class="card-footer"><code class="text-sm"><small> http://api.tecnicos.test/v1/deleteClients/{id}</small></code></div>
                                    </div>
